...
describe('Job e2e test', () => {
  ...
  it('should load Jobs', async () => {
    ...
    expect(await jobComponentsPage.getTitle()).to.eq('tfgpruebaApp.job.home.title');
  ...
  it('should load create Job page', async () => {
    ...
    expect(await jobUpdatePage.getPageTitle()).to.eq('tfgpruebaApp.job.home.createOrEditLabel');
  ...
  it('should create and save Jobs', async () => {
    ...
    await promise.all([
      ...
      jobUpdatePage.userSelectLastOption(),
  ...
  it('should delete last Job', async () => {
    ...
    expect(await jobDeleteDialog.getDialogTitle()).to.eq('tfgpruebaApp.job.delete.question');
